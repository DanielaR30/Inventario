   ...
   <div class="content-wrapper">
     ...
     <section class="content-header">
       ...
       <ol class="breadcrumb">
         ...
         <li class="breadcrumb-item"><a href="cargo.php">Bodega</a></li>       
       </ol>
   </section>
            ...
            <div class="row">
              <div class="col-md-12 ">
                  <div class="box">
                    ...
                    <div class="col-lg-6">
                    <h1 class="box-title" style="display:none; font-family: 'Sawarabi Gothic', sans-serif;" id="titulo1">Bodegas</h1>
                    <h1 class="box-title" style="display:none; font-family: 'Sawarabi Gothic', sans-serif;" id="titulo">Codificación de Bodega</h1>
                    ...
                    <div class="panel-body" style="height: 600px;" id="formularioregistros">
                        <form name="formulario" id="formulario" method="post">                    
                         ...
                         <div class="inputWithIcon form-group col-lg-6 col-md-6 col-sm-6 col-xs-12"> 
                           ...
                           <div class="inputWithIcon form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                              <label for="NmBodega">Nombre</label>
                              <input type="text" class="form-control" name="NmBodega" id="NmBodega" required>
                      ...
                      <div class="row">
                          <div class="inputWithIcon form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <label for="FlActiva">Estado</label>
                                <select class="form-control" class="form-control" name="FlActiva" id="FlActiva">
                                  <option value="" selected disabled>Seleccione el estado de la bodega</option>
