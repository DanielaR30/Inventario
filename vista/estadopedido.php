         ...
         <li class=""><a href="Index/index.php"><i class="fas fa-home"></i><span>&nbsp; Inicio</span></a></li> 
                   ...
                   <li class="treeview  active">
                          ...
                          <ul class="treeview-menu">                                              
                           ...
                           <li ><a href="#"><i class="fas fa-toggle-on"></i>&nbsp; Estado de los Productos</a></li>    
                           ...
                           <li class="active"><a href="#"><i class="fas fa-clipboard-check"></i>&nbsp; Estado de los Pedidos</a></li>
   ...
   <div class="content-wrapper">
     ...
     <section class="content-header">
       ...
       <ol class="breadcrumb">            
         ...
         <li class="breadcrumb-item"><a href="segmento.php">Estado de los Productos</a></li>
       </ol>
   </section>
...
<!--Contenido-->
      <!-- Content Wrapper. Contains page content -->
        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-lg-6">
                  <h1 class="box-title" style="display:none; font-family: 'Sawarabi Gothic', sans-serif;" id="titulo1">Estado de los Productos</h1>
                  <h1 class="box-title" style="display:none; font-family: 'Sawarabi Gothic', sans-serif;" id="titulo">Codificación de Estado del Producto</h1> 
                        ...
                        <form name="formulario" id="formulario" method="post">
                         ...
                         <div class="row">
                             <div class="inputWithIcon form-group col-lg-6 col-md-6 col-sm-6 col-xs-12" style="display:none;"> 
                                <label for="IdEstadoPedido">Código</label>
                                <input type="number"  class="form-control" name="IdEstadoPedido" id="IdEstadoPedido">
                             ...
                             <div class="inputWithIcon form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <label for="NmEstadoPedido">Estado</label>
                                <input type="text"  class="form-control" name="NmEstadoPedido" id="NmEstadoPedido">
...
require 'footer.php';
?>
<script src="js/estadopedido.js"></script>
