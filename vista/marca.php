         ...
         <li class="header">MENÚ PRINCIPAL</li>
                   ...
                   <li class="treeview  active">
                          ...
                          <ul class="treeview-menu">                                              
                           ...
                           <li class="active"><a href="marca.php"><i class="fas fa-tag"></i>&nbsp; Marcas</a></li>    
   ...
   <div class="content-wrapper">
     ...
     <section class="content-header">
       ...
       <ol class="breadcrumb">            
         ...
         <li class="breadcrumb-item"><a href="segmento.php">Marcas</a></li>
       </ol>
   </section>
...
<!--Contenido-->
      <!-- Content Wrapper. Contains page content -->
        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-lg-6">
                  <h1 class="box-title" style="display:none; font-family: 'Sawarabi Gothic', sans-serif;" id="titulo1">Marcas</h1>
                  <h1 class="box-title" style="display:none; font-family: 'Sawarabi Gothic', sans-serif;" id="titulo">Codificación de Marcas</h1> 
                        ...
                        <form name="formulario" id="formulario" method="post">
                         ...
                         <div class="row">
                             <div class="inputWithIcon form-group col-lg-6 col-md-6 col-sm-6 col-xs-12" style="display:none;"> 
                                <label for="IdMarca">Código</label>
                                <input type="number"  class="form-control" name="IdMarca" id="IdMarca">
                              ...
                              <div class="inputWithIcon form-group col-lg-6 col-md-6 col-sm-6 col-xs-12"> 
                                <label for="NmMarca">Nombre</label>
                                <input type="text"  class="form-control" name="NmMarca" id="NmMarca">
