   ...
   <div class="content-wrapper">
     ...
     <section class="content-header">
       ...
       <ol class="breadcrumb">
         ...
         <li class="breadcrumb-item"><a href="clase.php">Clases</a></li>
       </ol>
   </section>
            ...
            <div class="row">
              <div class="col-md-12 ">
                  <div class="box">
                    ...
                    <div class="col-lg-6">
                    <h1 class="box-title" style="display:none; font-family: 'Sawarabi Gothic', sans-serif;" id="titulo1">Clases</h1>
                    <h1 class="box-title" style="display:none; font-family: 'Sawarabi Gothic', sans-serif;" id="titulo">Codificación de clase</h1> 
                    ...
                    <div class="panel-body" style="height: 600px;" id="formularioregistros">
                        ...
                        <div class="row">
                            ...
                            <label for="IdClase">Código</label>
                            <input type="text" class="form-control" name="IdClase" id="IdClase" required > 
                        ...
                        <div class="row">
                            <div class="inputWithIcon form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <label for="NmClase">Nombre</label>
                                <input type="text" class="form-control" name="NmClase" id="NmClase" required>
