   ...
   <div class="content-wrapper">
     ...
     <section class="content-header">
       ...
       <ol class="breadcrumb">            
         ...
         <li class="breadcrumb-item"><a href="segmento.php">Lineas</a></li>
       </ol>
   </section>
...
<!--Contenido-->
      <!-- Content Wrapper. Contains page content -->
        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-lg-6">
                  <h1 class="box-title" style="display:none; font-family: 'Sawarabi Gothic', sans-serif;" id="titulo1">Líneas</h1>
                  <h1 class="box-title" style="display:none; font-family: 'Sawarabi Gothic', sans-serif;" id="titulo">Codificación de Líneas</h1> 
                        ...
                        <form name="formulario" id="formulario" method="post">
                         ...
                         <div class="row">
                             <div class="inputWithIcon form-group col-lg-6 col-md-6 col-sm-6 col-xs-12" style="display:none;"> 
                                <label for="IdLinea">Código</label>
                                <input type="number"  class="form-control" name="IdLinea" id="IdLinea">
                              ...
                              <div class="inputWithIcon form-group col-lg-6 col-md-6 col-sm-6 col-xs-12"> 
                                <label for="NmLinea">Nombre</label>
                                <input type="text"  class="form-control" name="NmLinea" id="NmLinea">
