         ...
         <li class="header">MENÚ PRINCIPAL</li>
                   ...
                   <li class="treeview  active">
                          ...
                          <ul class="treeview-menu">                                              
                           ...
                           <li class="active"><a href="unidadmedida.php"><i class="fas fa-boxes"></i>&nbsp; Unidades de Medida</a></li>                                
   ...
   <div class="content-wrapper">
     ...
     <section class="content-header">
       ...
       <ol class="breadcrumb">            
         ...
         <li class="breadcrumb-item"><a href="segmento.php"> Unidades de Medida</a></li>
       </ol>
   </section>
...
<!--Contenido-->
      <!-- Content Wrapper. Contains page content -->
        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-lg-6">
                  <h1 class="box-title" style="display:none; font-family: 'Sawarabi Gothic', sans-serif;" id="titulo1">Unidades de Medida</h1>
                  <h1 class="box-title" style="display:none; font-family: 'Sawarabi Gothic', sans-serif;" id="titulo">Codificación de Unidades de Medida</h1> 
                    ...
                    <div class="panel-body" style="height: 600px;" id="formularioregistros">
                        <form name="formulario" id="formulario" method="post">
                         ...
                         <div class="row">
                             <div class="inputWithIcon form-group col-lg-6 col-md-6 col-sm-6 col-xs-12" style="display:none;"> 
                                ...
                                <input type="text"  class="form-control" name="IdUnidadMedida" id="IdUnidadMedida">
                                <span class="info" style="display:none; color:rgba(230, 35, 18, 0.952);">
                        ...
                        <div class="row">
                            <div class="inputWithIcon form-group col-lg-6 col-md-6 col-sm-6 col-xs-12"> 
                                <label for="CdUnidadMedida">Cd UnidadMedida</label>
                                <input type="text"  class="form-control" name="CdUnidadMedida" id="CdUnidadMedida">
                                <span class="infou" style="display:none; color:rgba(230, 35, 18, 0.952);">
                                  <i class="fas fa-exclamation-circle"> Campo requerido, Ingrese máximo 3 caracteres.</i> 
                                </span>
                             </div> 
                        </div>
                      ...
                      <div class="row">
                            <div class="inputWithIcon form-group col-lg-6 col-md-6 col-sm-6 col-xs-12"> 
                                <label for="NmUnidadMedida">Nombre</label>
                                <input type="text"  class="form-control" name="NmUnidadMedida" id="NmUnidadMedida">
