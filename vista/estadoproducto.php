         ...
         <li class="header">MENÚ PRINCIPAL</li>
                   ...
                   <li class="treeview  active">
                          ...
                          <ul class="treeview-menu">                                              
                           ...
                           <li class="active"><a href="estadoproducto.php"><i class="fas fa-toggle-on"></i>&nbsp; Estado de los Productos</a></li>    
                        ...
                        <form name="formulario" id="formulario" method="post">
                         ...
                         <div class="row">
                             <div class="inputWithIcon form-group col-lg-6 col-md-6 col-sm-6 col-xs-12" style="display:none;"> 
                                <label for="IdEstadoProducto">Código</label>
                                <input type="number"  class="form-control" name="IdEstadoProducto" id="IdEstadoProducto">
                             ...
                             <div class="inputWithIcon form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <label for="NmEstadoProducto">Estado</label>
                                <input type="text"  class="form-control" name="NmEstadoProducto" id="NmEstadoProducto">
