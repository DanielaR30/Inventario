   ...
   <div class="content-wrapper">
     ...
     <section class="content-header">
       ...
       <ol class="breadcrumb">
         ...
         <li class="breadcrumb-item" ><a href="oficina.php">Oficinas</a></li>        
       </ol>
   </section>
            ...
            <div class="row">
              <div class="col-md-12 ">
                  <div class="box">
                    ...
                    <h1 class="box-title" style="display:none; font-family: 'Sawarabi Gothic', sans-serif;" id="titulo1">Oficinas</h1>
                    <h1 class="box-title" style="display:none; font-family: 'Sawarabi Gothic', sans-serif;" id="titulo">Codificación de oficina</h1>
                    ...
                    <div class="panel-body" style="height: 600px;" id="formularioregistros">
                        ...
                        <div class="inputWithIcon form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label for="idOficina">Código</label>
                            <input type="number" class="form-control" name="idOficina" id="idOficina" required>
                              <span class="inforid" style="display:none; color:rgba(230, 35, 18, 0.952);">
                               <i class="fas fa-exclamation-circle"> Campo requerido.</i> 
                              </span>
                         </div> 
                         <div class="inputWithIcon form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label for="NmOficina">Nombre</label>
                       ...
                       <div class="inputWithIcon form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                          ...
                          <div class="inputWithIcon form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <span class="infoTe" style="display:none; color:rgba(230, 35, 18, 0.952);">
                              <i class="fas fa-exclamation-circle"> Campo requerido, Ingrese un numero válido(7 dígitos).</i>
                            </span>
                          </div>
                       </div>
